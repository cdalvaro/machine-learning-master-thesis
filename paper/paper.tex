...
\begin{itemize}
  \item \textbf{deep autoencoder:} it is a neural network that learns to copy its input
        ...
        We train it before passing the data through the next component, the
...
many stars to the group \emph{0} (purple) that should belong to group \emph{g1}. These badly assigned stars
  ...
  \begin{center}
    \resizebox{\columnwidth}{!}{
      \begin{tabular}{l|c|c|c|c}
        ...
        Clusterix & -10.970 \( \pm \) 0.322 & -2.958 \( \pm \) 0.327 & 1.142 \( \pm \) 0.080 & 649 \\
