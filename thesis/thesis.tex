...
the 0.25 and 0.75 quantiles for each group, respectively.
...
The errors associated to KMeans and DEC predictions are calculated as the Standard Error $SE = \sigma / \sqrt{N}$,
where $N$ is the number of samples in the selected group.
...
Compared with the mentioned tools, our model can be fully calified as a non-parameterized model
...
% TODO: Add references to figures and tables
