...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.9\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../figures/features_melotte_22.pdf}
  \end{subfigure}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.9\textwidth}
    ...
    \begin{subfigure}[t]{.45\textwidth}
      \centering
      \includegraphics[width=\textwidth]{../figures/kmeans_pm_melotte_22.pdf}
      \caption{Proper Motion}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{.45\textwidth}
      \centering
      \includegraphics[width=\textwidth]{../figures/kmeans_parallax_melotte_22.pdf}
      \caption{Parallax}
    \end{subfigure}
  \end{subfigure}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../figures/kmeans_isochrone_melotte_22.pdf}
  \end{subfigure}
