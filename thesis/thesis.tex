...
\begin{figure}[htbp]
  ...
  \caption{Typical Clusterix 2.0 control panel.}
...
Finally, Figure \ref{fig:hr_diagram_comparison} shows a comparison between the H-R diagram obtained by DEC clustering and the one obtained
