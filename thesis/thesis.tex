...
%% TODO: Fit structure to: general, specific, methodology

% General: Caracterizar cúmulos abiertos
% Específicos:
% Obtener los datos requeridos para el análisis
% Identificar los posibles métodos de clustering
% Diseñar e implementar distintos algoritmos de clustering
% Determinar la validez de los clusters caracterizados
...
%% TODO: Añadir nuevo capítulo - Discusión
...
%% TODO: 7.2 Lineas de trabajo futuro
