...
This contrasts with \citeA{castro2020hunting} work,
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.9\textwidth}
    ...
    \end{subfigure}
  \end{subfigure}
  \caption{NGC 2516 KMeans characterization. Identified as cluster \emph{g3}.}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.9\textwidth}
    ...
    \end{subfigure}
  \end{subfigure}
  \caption{NGC 2632 KMeans characterization. Identified as cluster \emph{g1}.}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.9\textwidth}
    ...
    \end{subfigure}
  \end{subfigure}
  \caption{NGC 2682 KMeans characterization. Identified as cluster \emph{g4}.}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.9\textwidth}
    ...
    \end{subfigure}
  \end{subfigure}
  \caption{Melotte 25 KMeans characterization. Identified as cluster \emph{g3}.}
...
\begin{table}[h]
  \begin{center}
    \begin{tabular}{l|c|c|c|c}
      ...
      KMeans & 79.380 $\pm$ 3.7 & -45.314 $\pm$ 3.8 & 20.866 $\pm$ 0.31 & 376 \\
      DEC & 76.463 $\pm$ 3.6 & -43.941 $\pm$ 3.6 & 20.489 $\pm$ 0.31 & 396 \\
      \textbf{DEC (filtered)} & 81.795 $\pm$ 3.7 & -40.049 $\pm$ 3.1 & 19.888 $\pm$ 0.13 & 316 \\
    \end{tabular}
...
Compared with the mentioned tools, our model can be classified as a non-parameterized model
since it does not depend on parameters referred to the cluster itself
...
which stars belong to the cluster or assit it while its training stage.
...
So we have succedded building a model non-parameterized and non-supervised for open cluster characterization.
...
Although some tweaks can be done regarding the cluster,
...
Even so, comparing our method with Clusterix,
...
We could determine with better accuracy the topologies that our model works well with,
and which ones the model does not resolve properly.
Even, we could stablish different sets of hyperparameters regarding the topology of the cluster.
...
At last, we have used the Gaia DR2 database as our data source for this work,
